...
<section class="freddo_onepage_section freddo_contact <?php echo $contactShortcode ? 'withForm' : 'noForm' ?>" id="<?php echo esc_attr($contactSectionID); ?>">
	...
	<div class="freddo_action_contact">
		...
		<p class="freddo_subtitle">
			<?php echo esc_html($contactSubTitle); ?>
		</p>
		<?php endif; ?>
		<div class="contact_columns">
			<h3 class="title h_f" style="text-align: center;margin-bottom: 3em">Celebrated Institutions and companies，build an
				enormous and multivariate ecology.</h3>
			<div class="partenrs_box">
				<ul class="partners clearfix">
					...
					<li>
						<img class="img_one" src="<?php echo get_template_directory_uri(); ?>/images/demo/partners/gray/Gray_19_Logo_Bixin.svg">
						<img class="img_two" src="<?php echo get_template_directory_uri(); ?>/images/demo/partners/color/Color_19_Logo_Bixin.svg">
					</li>
				</ul>
			</div>
		</div>
