...
<section class="freddo_onepage_section freddo_features" id="<?php echo esc_attr($featuresSectionID); ?>">
	...
	<div class="freddo_action_features">
		...
		<h2 class="freddo_main_text">
			<?php echo esc_html($featuresTitle); ?>
		</h2>
		<?php endif; ?>
		<?php if($featuresSubTitle || is_customize_preview()): ?>
		<p class="freddo_subtitle">
			<?php echo esc_html($featuresSubTitle); ?>
		</p>
		<?php endif; ?>
		<div class="features_columns">
			...
			<div class="one features_columns_single">
				...
				<h3>
					<?php echo get_the_title(intval($choosePageBox1)); ?>
				</h3>
				<?php
					...
					?>
				<p>
					<?php echo wp_trim_words($content1 , intval($textLenght), esc_html($customMore) ); ?>
				</p>
				<?php endif; ?>
				<?php if($textButton1 || is_customize_preview()): ?>
				<div class="freddoButton features"><a href="<?php echo esc_url($linkButton1); ?>">
						<?php echo esc_html($textButton1); ?></a></div>
				<?php endif; ?>
			</div>
			<?php endif; ?>
			...
			<div class="two features_columns_single">
				...
				<h3>
					<?php echo get_the_title(intval($choosePageBox2)); ?>
				</h3>
				<?php
					...
					?>
				<p>
					<?php echo wp_trim_words($content2 , intval($textLenght), esc_html($customMore) ); ?>
				</p>
				<?php endif; ?>
				<?php if($textButton2 || is_customize_preview()): ?>
				<div class="freddoButton features"><a href="<?php echo esc_url($linkButton2); ?>">
						<?php echo esc_html($textButton2); ?></a></div>
				<?php endif; ?>
			</div>
			<?php endif; ?>
				...
				<div class="content clearfix">
					<ul class="clearfix">
						...
						<li>
							...
							<p>Bytom 0.1.0 BigBang version released. China Hangzhou’s First Public Chain Bytom Releases The Alpha Testnet
								"BigBang".</p>
						</li>
						<li>
						...
						<li>
							...
							<p>BThe release of smart contract also marks the establishment of its core, which will further promote the
								commercialization of the project.</p>
						</li>
						<li>
							<h2 class="freddo_main_text">Network / Basic Expansions / Contract Support</h2>
							<p>Network: Large-scale deployment and monitoring of full nodes and light nodes, and peer-to-peer network
								communication and route upgrades.<br />Basic Expansions: Polish Blockchain Explorer, mobile wallet, ODIN-based
								public chain ID system.<br />Contract Support: SDK Development, Enterprise-level Smart Asset Signature System,
								Bytom Virtual, Machine(BVM) Multi-language Support Phase1.</p>
						</li>
						<li>
							<h2 class="freddo_main_text">ToB DAPP Development Support</h2>
							<p>Business side compliance commercial application DAPP development support: Corporate Digital Financial
								Management System, Multi-asset configuration DAPP series, Peer-to-peer financial application suite,
								Blockchainized assets market, BVM Virtual Machine Multi-language Support Phase2.</p>
						</li>
						<li>
							<h2 class="freddo_main_text">Ecosystem and Business</h2>
							<p>1、The first batch of partners reach cooperation. 2、Realize the circulation of multiple asset on chain.
								3、Bytom First Developer Conference Bytom Devcon 1. 4、Bytom Asset Ecology Conference Asset 2020</p>
						</li>
					</ul>
				</div>
			</div>
			...
			<div class="four features_columns_single">
				...
				<h3>
					<?php echo get_the_title(intval($choosePageBox3)); ?>
				</h3>
				<?php
					...
					?>
				<p>
					<?php echo wp_trim_words($content3 , intval($textLenght), esc_html($customMore) ); ?>
				</p>
				<?php endif; ?>
				<?php if($textButton3 || is_customize_preview()): ?>
				<div class="freddoButton features"><a href="<?php echo esc_url($linkButton3); ?>">
						<?php echo esc_html($textButton3); ?></a></div>
				<?php endif; ?>
			</div>
			<div class="four features_columns_single">
				...
				<h3>
					<?php echo get_the_title(intval($choosePageBox4)); ?>
				</h3>
				<?php
					...
					?>
				<p>
					<?php echo wp_trim_words($content4 , intval($textLenght), esc_html($customMore) ); ?>
				</p>
				<?php endif; ?>
				<?php if($textButton4 || is_customize_preview()): ?>
				<div class="freddoButton features"><a href="<?php echo esc_url($linkButton4); ?>">
						<?php echo esc_html($textButton4); ?></a></div>
				<?php endif; ?>
			</div>
			<?php endif; ?>
		</div>
